  ...
  <div v-else>
    <vs-row vs-justify="center" vs-align="flex-end" vs-type="flex" v-if="posts && posts.length > 0">
      <vs-col vs-w="6" vs-justify="flex-start" vs-align="center" vs-type="flex" class="mb-8">
        <span @click="$to('search')" class="post-theme__category--title">Berita Lainnya</span>
      </vs-col>
      <vs-col vs-w="6" vs-justify="flex-end" vs-align="center" vs-type="flex" class="mb-8">
        <span @click="$to('search')" class="d-flex justify-content-center align-items-center text-black"><span class="post-theme__category--see-all">LIHAT SEMUA</span> <vs-icon icon="chevron_right" size="12px"></vs-icon></span>
      </vs-col>
      <vs-col>
        <vs-card class="post-theme__other--card mb-0">
            ...
            <vs-row vs-type="flex" vs-justify="center" vs-align="flex-start">
              ...
              <vs-col vs-xs="12" vs-sm="12" vs-lg="8" class="pl-24">
                ...
                <vue-clamp :max-lines="3" class="post-theme__other--card-description">
                  {{ post.summary }}
                  <template slot="after">
                    <span @click="$to('post', post.slug)" class="post-theme__other--read-more">Baca Selengkapnya</span>
                  </template>
                </vue-clamp>
              </vs-col>
